    ...
    <main>
        ...
        <div class="facilitydivmain">
            <div id="facilityleft">
                ...
                <br><br><br><br>
                <div class="facilitiesdiv">
                    <span><b>Music and Dance Studio:</b></span>
                    At TISA Music and Dance take high priority as a creative medium of human expressions. Music and
                    Dance are taught by specialist to all students throughout the school. Drama is taught as a
                    timetabled subject.
                </div>
                <br><br><br><br>
                <div class="facilitiesdiv">
                    <span><b>Puppet theatre:</b></span>
                    We at The International School of Agra have puppet theatre where short motivational stories are
                    displayed with the help of puppets as a means to imbibe moral values within the children.
                </div>
                <br><br><br><br>
                <div class="facilitiesdiv">
                    <span><b>School Cinema:</b></span>
                    Through School Cinema Students at The International School of Agra will learn to build a better
                    relationship with their peer group and also learn to establish a better relationship with Parents
                    and Teachers. Every student is involved in watching 10 movies specially addressing value development
                    at each age group. One movie is also shown to parents and teachers in each Grade.
                </div>
                <br><br><br><br>
            </div>
            <div class="aside">
                <div class="facility_aside_heading">
                    <img src="paperrocket.jpeg" alt="pr">
                    <h3> Facilities</h3>
                </div>
                <div class="facility_aside_list_main_div">
                    <div class="facility_aside_list_div">
